...
#include "customWidgets/statechip.h"
...
bool StateChip::isValid() const
{
    return m_isValid;
}


void StateChip::changeEvent(QEvent* event)
{
    if ( event->type() == QEvent::DynamicPropertyChange ) {
        if ( property("checkedState").isValid() )
        {
            this->setValidityState( property("checkedState").toBool() );
        }
    }
